...
| エントリの並べ替え | ドラッグハンドルでドラッグ&ドロップ |
| スクラップを開く | コマンドパレットから「Open Zen Scrap」 |

プラグイン内の詳細画面からも「ショートカットガイド」リンクで同じ内容を確認できる。
...
- アウトラインボタンからエントリ一覧を開き、クリックで目的のエントリにジャンプ。ホバーでエントリ内容のツールチップを表示
- 幅切り替えボタンで表示幅をワイド/通常に切り替え
